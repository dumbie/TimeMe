...
namespace TimeMeTaskAgent
{
    ...
    {
        //Draw Wide Multi Live Tile
        async Task ClockTileWideMulti()
        {
            try
            {
                ...
                if (!TileRenderVarsLoaded)
                {
                    ...
                    Win2DCanvasTextFormatTextCenter = new CanvasTextFormat() { FontFamily = "Segoe UI", FontWeight = Win2DFontWeightText, FontSize = 31 + (setLiveTileFontSize / 2), WordWrapping = CanvasWordWrapping.NoWrap, HorizontalAlignment = CanvasHorizontalAlignment.Center, VerticalAlignment = CanvasVerticalAlignment.Bottom };
