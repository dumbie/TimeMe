...
namespace TimeMeTaskAgent
{
    ...
    {
        //Draw Wide Multi More Live Tile
        async Task ClockTileWideMultiMore()
        {
            try
            {
                ...
                if (!TileRenderVarsLoaded)
                {
                    ...
                    Win2DCanvasTextFormatTextCenter = new CanvasTextFormat() { FontFamily = "Segoe UI", FontWeight = Win2DFontWeightText, FontSize = 29 + (setLiveTileFontSize / 2), WordWrapping = CanvasWordWrapping.NoWrap, HorizontalAlignment = CanvasHorizontalAlignment.Center, VerticalAlignment = CanvasVerticalAlignment.Bottom };
